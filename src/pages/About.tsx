  ...
  return (
    <>
      ...
      <main className="max-w-3xl mx-auto px-6 py-20 font-aspekta text-foreground/80 leading-relaxed">
        ...
        <p>Stint was built by <a href="https://www.inigohernandez.design/" target="_blank" rel="noopener noreferrer" className="underline">Iñigo Hernandez</a>. The project lives at <a href="https://stint.run" className="underline">stint.run</a>.</p>
      </main>
      <Footer />
    </>
  );
