        ...
        <div className="relative z-10 w-full h-full flex flex-col min-h-0">
          ...
          <div className="hidden xl:flex xl:flex-col xl:h-full xl:p-8">
            ...
            <div className="flex justify-between items-start flex-shrink-0 mb-6">
              ...
              <div className="text-right">
                <div className="text-base font-normal mb-1 text-foreground/60">
                  Remaining time
                </div>
            ...
            <div className="flex justify-between items-end flex-shrink-0 mt-6">
              {/* Cycles - Bottom Left */}
              <div>
                <div className="text-base font-normal mb-2 text-foreground/60">
                  Cycles
                </div>
                <div 
          ...
          <div className="md:flex md:flex-col md:h-full xl:hidden p-4 md:p-6 lg:p-8">
            ...
            <div className="flex justify-between items-start flex-shrink-0 mb-4 lg:mb-6 relative">
              ...
              <div className="absolute top-0 right-0 text-right">
                <div className="text-sm lg:text-base font-normal mb-1 text-foreground/60">
                  Remaining time
                </div>
            ...
            <div className="flex justify-between items-end flex-shrink-0 mt-4 lg:mt-6 mb-4 lg:mb-6">
              {/* Cycles - Bottom Left */}
              <div>
                <div className="text-sm lg:text-base font-normal mb-1 lg:mb-2 text-foreground/60">
                  Cycles
                </div>
                <div 
          ...
          <div className="md:hidden flex flex-col h-full p-4">
            ...
            <div className="flex justify-between items-start mb-4 flex-shrink-0">
              ...
              <div className="text-right">
                <div className="text-xs font-normal mb-1 text-foreground/60">
                  Remaining time
                </div>
      ...
      <div className="relative z-10 w-full h-full flex flex-col">
        ...
        <div className="hidden md:flex md:flex-col md:h-full md:p-4 lg:p-8">
          ...
          <div className="flex justify-between items-end flex-shrink-0 pt-4">
            <div>
              <div className="text-sm md:text-base font-normal mb-2 text-foreground/60">
                Cycles
              </div>
              <div 
